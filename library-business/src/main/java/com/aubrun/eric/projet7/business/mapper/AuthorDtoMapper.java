...
public class AuthorDtoMapper {
    ...
    static public AuthorDto toDto(Author author) {
        ...
        dto.setBookDtos(author.getBooks().stream().sorted().map(BookDtoMapper::toDto).collect(Collectors.toList()));
        return dto;
    }
    ...
    static public Author toEntity(AuthorDto authorDto) {
        ...
        entity.setBooks(authorDto.getBookDtos().stream().sorted().map(BookDtoMapper::toEntity).collect(Collectors.toList()));
        return entity;
    }
}
