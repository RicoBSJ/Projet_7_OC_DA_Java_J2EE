...
public class UserAccountDtoMapper {
    ...
    static public UserAccountDto toDto(UserAccount userAccount) {
        ...
        dto.setRoles(userAccount.getRoles().stream().map(RoleDtoMapper::toDto).collect(Collectors.toList()));
        return dto;
    }
    ...
    static public UserAccount toEntity(UserAccountDto userAccountDto) {
        ...
        entity.setRoles(userAccountDto.getRoles().stream().map(RoleDtoMapper::toEntity).collect(Collectors.toList()));
        return entity;
    }
}
