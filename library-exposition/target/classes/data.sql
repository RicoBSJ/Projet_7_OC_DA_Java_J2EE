...
values
(setval('book_id_seq', 1), 3, 1, false, 'La grève', '2017-03-09', 1, 1, 1),
...
(nextval('book_id_seq'), 3, 1, false, 'De la liberté', '1996-03-22', 3, 3, 3),
...
(nextval('book_id_seq'), 3, 1, false, 'Plénitude de la vie', '2003-09-08', 3, 3, 3),
(nextval('book_id_seq'), 3, 1, false, 'La Relation de l''homme au monde', '1995-02-23', 3, 3, 3),
(nextval('book_id_seq'), 3, 1, false, 'La Vérité et l''évènement', '2010-10-01', 3, 3, 3),
